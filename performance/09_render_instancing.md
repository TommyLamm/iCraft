...
> 狀態：Partial
> 原完成宣告時間：2026-07-28
> 審核回退：見 [`15_performance_audit_repair_plan.md`](15_performance_audit_repair_plan.md)；基本 instancing 已存在，但 instance ring 無 GPU completion 保護、particle instance 缺 color/light，且無性能/視覺 parity artifact，待 R7、R9 修復。
