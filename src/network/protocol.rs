...
/// Protocol v17 retains the private, bounded projection introduced in v16 and
/// adds the raw-fluid carrier plus typed water-bucket operation. Older clients
/// are rejected during the existing handshake instead of silently losing
/// authoritative state.
