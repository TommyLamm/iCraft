...
/// Protocol v16 adds a private, bounded projection of the complete
/// authoritative gameplay session. Older clients are rejected during the
/// existing handshake instead of silently losing inventory, XP or death state.
