...
/// Protocol v18 adds the typed, authoritative block-action envelope and the
/// owner-private mining-progress projection. Older clients are rejected during
/// the existing handshake instead of silently losing authoritative state.
...
mod tests {
    ...
    #[test]
    fn intermediate_v17_handshake_is_not_accepted_by_v18_contract() {
