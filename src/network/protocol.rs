...
/// Protocol v15 extends the authoritative gameplay envelope with bounded,
/// metadata-preserving domain requests. Older clients are rejected during the
/// existing handshake instead of being allowed to settle those transactions
/// locally.
