//! Shared 5×7 line and solid glyph bitmaps.
//!
//! Desktop-only helpers used by menu and in-game HUD text rendering.
...
mod tests {
    ...
    #[test]
    fn glyph_bitmaps_cover_alphanumeric_and_symbols() {
        let a = glyph('A');
