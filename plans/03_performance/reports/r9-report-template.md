...
```powershell
pwsh plans/03_performance/tools/Validate-R9Jsonl.ps1 -Path <raw.jsonl>
pwsh plans/03_performance/tools/Measure-R9Runs.ps1 -InputPath <raw-root> -ManifestPath <manifest.json>
git diff --check
```
