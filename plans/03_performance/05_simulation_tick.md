...
> 狀態：Complete
> 審核修復：見 [`15_performance_audit_repair_plan.md`](15_performance_audit_repair_plan.md)；20 Hz accumulator 已存在，但目前只有合成位移測試，缺完整 world checksum，且 host pause/death policy 待 R4、R5、R9 修復。
> 前置：任務 1（基線）
