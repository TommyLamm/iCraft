...
> 狀態：Complete
> 審核修復：見 [`15_performance_audit_repair_plan.md`](15_performance_audit_repair_plan.md)；GPU timestamp readback、scope/counter 覆蓋與固定場景 artifact 尚未完成（R5、R9）。
...
### 1.6 建立固定 seed 場景
- [x] 檔案：`plans/03_performance/benchmarks/`（新增目錄與場景描述檔）
