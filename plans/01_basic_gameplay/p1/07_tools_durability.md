...
### 子任務清單
- [x] 定義 `ToolType` 和 `ToolMaterial` 枚舉
- [x] 每種方塊需要的工具類型 + 最低工具等級
- [x] 挖掘速度計算：`base_time / (tool_speed_multiplier)`
- [x] 手動挖掘：不使用正確工具時速度極慢
- [x] 挖掘進度系統：長按左鍵持續挖掘，進度滿後方塊被破壞

---

## 7.2 耐久度系統
- [x] 每次使用工具消耗 1 耐久
- [x] 耐久度歸零時工具損壞（播放音效，從背包移除）
- [x] 快捷欄/背包中顯示耐久條 (彩色漸變: 綠→黃→紅)

---

## 7.3 挖掘進度渲染
- [x] 長按左鍵時，方塊表面覆蓋 10 級破壞紋理
- [x] 破壞進度隨時間增加
- [x] 鬆開左鍵或切換目標時重置進度
- [x] 進度滿後方塊被移除 + 掉落物品
