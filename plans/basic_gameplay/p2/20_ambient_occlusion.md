...
- [x] 日間露天平面無棋盤格或對角亮暗線。
- [x] 方塊內角、牆地交界、洞穴與屋頂下方呈現柔和深度。
- [x] 玻璃、樹葉、植被與水岸沒有不自然實心黑影。
- [x] Chunk 邊界及角落放置／破壞方塊後無舊 AO 接縫。
- [x] Chunk 載入／卸載後無舊 AO 或缺面。
- [x] 準星、生物、粒子、裂紋、受傷閃爍、日夜光照與霧效無視覺回歸。
- [x] Release 模式連續跨 Chunk 與修改方塊時無持續卡頓。
