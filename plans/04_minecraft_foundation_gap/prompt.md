...
```text
plans/04_minecraft_foundation_gap/02_chest_storage.md
```
...
2. 開始修改前，必須完整閱讀：
   - ARCHITECTURE.md
   - plans/04_minecraft_foundation_gap/README.md
   - {{PLAN_FILE}}
...
- 更新 plans/04_minecraft_foundation_gap/README.md 的對應狀態，但不要改動其他計劃的狀態。
- 如既有 plans/01_basic_gameplay/progress.md 或 track.md 對本功能有直接聲明，同步修正；不要重寫無關歷史。
