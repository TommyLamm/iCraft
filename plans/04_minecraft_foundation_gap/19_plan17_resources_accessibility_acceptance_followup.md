...
- 更新 `17_qa_checklist.md`、`17_known_differences.md`、`plans/01_basic_gameplay/progress.md` 與 `ARCHITECTURE.md`，
...
- `plans/04_minecraft_foundation_gap/17_qa_checklist.md`、`17_known_differences.md`、
  `plans/01_basic_gameplay/progress.md`、`ARCHITECTURE.md`（D）
