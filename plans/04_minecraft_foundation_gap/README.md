...
2026-08-16 架構審查發現：Plan31／34 的 **typed** 路徑是對的，但現役 `BlockUse`／`ContainerClick` 適配器與若干生命週期／signed-Y／存檔洞仍繞過契約。後續硬化計劃不編號進本表，見 [`../05_review_hardening/README.md`](../05_review_hardening/README.md)（01–15）。
