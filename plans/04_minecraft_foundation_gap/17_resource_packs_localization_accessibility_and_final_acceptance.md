...
- [x] 更新 `README.md`、`ARCHITECTURE.md`、`plans/01_basic_gameplay/progress.md`，刪除／標記已過時舊計劃聲明。
...
- 修改：`README.md`、`ARCHITECTURE.md`、`plans/01_basic_gameplay/progress.md`、測試 harness
