...
> 狀態：Complete
> 審核修復：見 [`15_performance_audit_repair_plan.md`](15_performance_audit_repair_plan.md)；async LOS worker 無地形資料且永遠回 visible，stale graph/occluder/section ownership 亦未達驗收，待 R6 修復。
