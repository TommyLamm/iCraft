...
> 狀態：Partial
> 審核回退：見 [`15_performance_audit_repair_plan.md`](15_performance_audit_repair_plan.md)；release profile/Mailbox/DX12 已落實，但 FPS cap、真正 dynamic resolution、PGO A/B 與固定場景 artifact 待 R8、R9 修復。
