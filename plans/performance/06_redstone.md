...
> 狀態：Partial
> 審核回退：見 [`15_performance_audit_repair_plan.md`](15_performance_audit_repair_plan.md)；player occupant 使 sleep fast-path 在正常 gameplay 失效，且 differential test 不是獨立 reference，待 R5 修復。
